...
export default function SignupSigninModal() {
    ...
    const initialFormState = {
        ...
        password: "",
        confirmPassword: "",
        role: "BUYER", // Default role for signup, matching backend enum convention (e.g., BUYER, SELLER, ADMIN)
    };
    ...
    const handleSignup = async (e) => {
        ...
        // Call signup from AuthContext, which now returns a result object
    ...
    const handleSignin = async (e) => {
        ...
        // Call signin from AuthContext, it now returns a result object and handles all user types
            ...
            <div className="bg-white w-full max-w-md rounded-xl shadow-2xl p-6 sm:p-8 relative animate-fade-in max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex justify-center gap-0 mb-6 sm:mb-8 border-b border-gray-200">
                    <button
                        ...
                        className={`py-3 px-2 text-base sm:text-lg font-semibold transition-all duration-200 ease-in-out w-1/2 rounded-t-md ${
                            activeTab === "signup"
                                ? "border-b-3 border-blue-600 text-blue-600 bg-blue-50"
                                : "text-gray-500 hover:text-gray-800 border-b-3 border-transparent hover:bg-gray-100"
                        }`}
                    >
                        Sign Up
                    </button>
...
// FloatingInput and FloatingPasswordInput components (copied for completeness)
    ...
    return (
        <div className="relative mt-2">
            <input
                ...
                onBlur={onBlur}
                placeholder=" "
                className={`peer w-full px-3 pt-4 pb-2 text-base text-gray-900 border rounded-lg focus:outline-none focus:ring-2 focus:border-transparent ${
                    error
