						...
						<div ref={searchContainerRef} className="flex items-center">
							{searchVisible && (
								<form
									...
									className="mr-1 animate-fade-in-fast"
								>
									<input
										type="text"
										value={searchValue}
							...
							<button
								...
								className={`p-2 hover:bg-gray-100 rounded-full text-gray-700 ${
									searchVisible
										? searchValue.trim()
											? "bg-blue-100 hover:bg-blue-200 rounded-r-md rounded-l-none -ml-px border border-blue-500"
											: "bg-gray-100 rounded-r-md rounded-l-none -ml-px border border-gray-300"
										: ""
								}`}
